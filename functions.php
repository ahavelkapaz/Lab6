<?php
	...
	else if($option=="emailSOAP") // Comprobar si el usuario está matriculado en SW
	{
	...
	else if($option=="passSOAP") //Comprobar si es una contraseña segura (en base a una lista de contraseñas no seguras)
	{
		require_once('../lib/nusoap.php');
		require_once('../lib/class.wsdlcache.php');
